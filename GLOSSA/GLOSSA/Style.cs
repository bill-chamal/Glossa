...
namespace GLOSSA
{
    class TableColorc
    {
        public class GoogleColorTable : ProfessionalColorTable
        {
            public Color GoogleClicked = Color.FromArgb(232, 240, 254);
            public Color GoogleHover = Color.FromArgb(241, 243, 244);

            public override Color MenuItemSelected
            {
                get { return GoogleHover; }
            }
